...
export default function Home() {
  ...
  const allGames = [
    ...
    { id: 3, title: 'Memory Match', description: 'Train your brain with pairs', category: 'Memory', image: '/images/featured-memory.png', rating: '85', tag: 'Popular', tagColor: 'bg-orange-600', players: '3.1k', link: '/memory-match', isNew: false, isPopular: true },
