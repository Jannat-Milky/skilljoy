...
export default function Home() {
  ...
  const allGames = [
    ...
    { id: 5, title: 'Typing Race', description: 'Race against time, type fast', category: 'Typing', image: '/images/recommended-typing.png', rating: '79', tag: 'Hot', tagColor: 'bg-red-600', players: '2.1k', link: '/typing-race', isNew: true, isPopular: false },
